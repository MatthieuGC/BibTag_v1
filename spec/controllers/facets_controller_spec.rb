...
RSpec.describe FacetsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all facets as @facets" do
      ...
      expect(assigns(:facets)).to eq([facet])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested facet as @facet" do
      ...
      expect(assigns(:facet)).to eq(facet)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new facet as @facet" do
      ...
      expect(assigns(:facet)).to be_a_new(Facet)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created facet as @facet" do
        post :create, {:facet => valid_attributes}, valid_session
        expect(assigns(:facet)).to be_a(Facet)
        expect(assigns(:facet)).to be_persisted
      end

      it "redirects to the created facet" do
        post :create, {:facet => valid_attributes}, valid_session
        expect(response).to redirect_to(Facet.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved facet as @facet" do
        post :create, {:facet => invalid_attributes}, valid_session
        expect(assigns(:facet)).to be_a_new(Facet)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested facet" do
        facet = Facet.create! valid_attributes
        put :update, {:id => facet.to_param, :facet => new_attributes}, valid_session
        facet.reload
      ...
      it "redirects to the facet" do
        facet = Facet.create! valid_attributes
        put :update, {:id => facet.to_param, :facet => valid_attributes}, valid_session
        expect(response).to redirect_to(facet)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the facet as @facet" do
        facet = Facet.create! valid_attributes
        put :update, {:id => facet.to_param, :facet => invalid_attributes}, valid_session
        expect(assigns(:facet)).to eq(facet)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the facets list" do
      facet = Facet.create! valid_attributes
      delete :destroy, {:id => facet.to_param}, valid_session
      expect(response).to redirect_to(facets_url)
    end
  end
